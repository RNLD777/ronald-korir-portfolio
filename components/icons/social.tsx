...
/**
 * Brand marks are not included in lucide-react v1, so the official simple-icons
 * paths are inlined here. They inherit colour via `currentColor` and accept the
 * same props as a lucide icon so they can be used interchangeably.
 */
